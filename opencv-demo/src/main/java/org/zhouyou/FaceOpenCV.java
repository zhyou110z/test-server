...
/**
 * @author DJZ-PJJ
 * @Description: 根据图片检测出图中的人脸，并加以标记
 * @date 2019/2/1616:30
 */
public class FaceOpenCV {
    ...
    static void face() {
        ...
        CascadeClassifier faceCV = new CascadeClassifier("F:\\LIB\\OpenCV\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_alt.xml");
        //2 读取测试图片
        Mat image = Imgcodecs.imread("G:\\11.jpg");
        //3 特征匹配
